...
## Project Structure
    ...
    ├── testapiautosetting_126617  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_126617`
...
2. Clone this repo and `cd testapiautosetting_126617`
